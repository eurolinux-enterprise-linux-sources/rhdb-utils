 ...
 *                 Version 8.4.0 for PostgreSQL 8.4
 *
...
DisplayOptions (unsigned int validOptions)
{
  if (validOptions == OPT_RC_COPYRIGHT)
    printf
      ("\nVersion 8.4.0 (PostgreSQL 8.4)  Copyright (c) 2002-2009 Red Hat, Inc.\n");
...
CreateDumpFileHeader (int numOptions, char **options)
{
  ...
  printf
    ("\n*******************************************************************\n"
     "* PostgreSQL File/Block Formatted Dump Utility - Version 8.4.0\n*\n"
     "* File: %s\n"
     "* Options used: %s\n*\n"
     "* Dump created on: %s"
     "*******************************************************************\n",
